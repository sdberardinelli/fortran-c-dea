...
//  printf("make_lp: rows: %d\n", rows);
//  printf("make_lp: columns: %d\n", columns);
//  printf("make_lp: lp->epsvalue: %f\n", lp->epsvalue);
...
//  printf("make_lp: ip addr 0x%X\n",lp);
//  printf("make_ip: ip->matA addr 0x%X\n",lp->matA);
//  printf("make_ip: ip->orig_obj addr 0x%X\n",lp->orig_obj);
//  printf("make_ip: ip->obj addr 0x%X\n",lp->obj);
...
{
//    printf("varmap_add: lp addr 0x%X\n", lp);
  int i, ii;
  presolveundorec *psundo = lp->presolve_undo;
  ...
  if(!lp->varmap_locked)
  {
//      printf("varmap_add: varmap_locked is not locked");
      return;
  }
...
{
//    printf("shift_rowdata: lp addr 0x%0X\n", lp);
  int i, ii;
...
//    printf("shift_rowdata: 3\n", lp);
  shift_basis(lp, base, delta, usedmap, TRUE);
//  printf("shift_rowdata: 4\n", lp);
  shift_rowcoldata(lp, base, delta, usedmap, TRUE);
//  printf("shift_rowdata: 5\n", lp);
  inc_rows(lp, delta);

//    printf("shift_rowdata: exit\n");
  return(TRUE);
}
...
{
//    printf("inc_row_space: lp addr 0x%X\n", lp);
//    printf("inc_row_space: lp->matA addr 0x%X\n",lp->matA);
//    printf("inc_row_space: lp->orig_obj addr 0x%X\n",lp->orig_obj);
//    printf("inc_row_space: lp->obj addr 0x%X\n",lp->obj);
...
//    printf("inc_row_space: here1\n");
  if(lp->matA->is_roworder) {

//        printf("inc_row_space: here1a\n");
...
{
//    printf("append_rows: lp addr 0x%X\n", lp);
//    printf("append_rows: lp->matA addr 0x%X\n",lp->matA);
...
{
//    printf("add_constraintx: lp addr 0x%X\n", lp);
//    printf("add_constraintx: lp->matA addr 0x%X\n",lp->matA);
//    printf("add_constraintx: lp->matA->columns %d\n",lp->matA->columns);
//    printf("add_constraintx: row addr 0x%X\n",row);
  int    n;
  MYBOOL status = FALSE;
  ...
  if(!append_rows(lp, 1))
  {
//      printf("add_constraintx: exit1\n");
    return( status );
  }

//    printf("add_constraintx: 1\n");
...
{
//    printf("add_constraint: lp addr 0x%X\n", lp);
//    printf("add_constraint: lp->matA addr 0x%X\n",lp->matA);
...
{
//    printf("set_lp_name: lp addr 0x%X\n", lp);
//    printf("set_lp_name: lp->matA addr 0x%X\n",lp->matA);
...
{
//    printf("get_lp_name: lp addr 0x%X\n", lp);
//    printf("get_lp_name: lp->matA addr 0x%X\n",lp->matA);
...
STATIC void set_biton(MYBOOL *bitarray, int item)
{
  bitarray[item / 8] |= (1 << (item % 8));
}


STATIC void set_bitoff(MYBOOL *bitarray, int item)
{
  bitarray[item / 8] &= ~(1 << (item % 8));
}


STATIC MYBOOL is_biton(MYBOOL *bitarray, int item)
{
